...
for start in starts:
    ...
    model = Sequential()
    model.add(Bidirectional(LSTM(64), input_shape=(timesteps, len(features))))
...
if best_model is not None:
    ...
    save_model(best_model, "IA_training/model/best_lstm_model_v6.keras")
    ...
    with open("IA_training/model/model_config_v6.pkl", "wb") as f:

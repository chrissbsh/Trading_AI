...
from tensorflow.keras.layers import LSTM, Dense, Dropout, LayerNormalization, Bidirectional # type: ignore
...
if best_model is not None:
    ...
    save_model(best_model, "IA_training/model/best_lstm_model_v7.keras")
    ...
    with open("IA_training/model/model_config_v7.pkl", "wb") as f:

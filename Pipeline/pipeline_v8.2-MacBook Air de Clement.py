...
def main(cross_validation, debug_on):
    ...
    raw_feats = select_top_features_shap(df_main, top_n=TOP_N_FEATURES, target_col="target")
    ...
    correlations = df_main[final_feats + ['target']].corr()['target'].sort_values(ascending=False)
    print("Top 10 features les plus corrélées avec la target:")

...
if __name__ == "__main__":
    ...
    selected_model_arch = "lstm_v2" # or "lstm_v2" or "gru" if you implement it
    ...
    wf_results, best_set = run_training_pipeline(model_name=selected_model_arch, feature_selection_on=False)
